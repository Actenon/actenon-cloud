...
require_file "docs/REPO_BOOTSTRAP_PLAN.md" "Bootstrap plan is present"
require_file "docs/SYSTEM_EXPLANATION_PLAIN_ENGLISH.md" "Plain-English system explanation is present"
require_file "docs/SYSTEM_EXPLANATION_ENGINEERING.md" "Engineering system explanation is present"
require_file "docs/LIVE_PILOT_OVERVIEW.md" "Live pilot overview document is present"
require_file "docs/DEPLOYMENT_AND_OPERATIONS_INDEX.md" "Deployment and operations index is present"
require_file "docs/CUSTOMER_HANDOFF_GUIDE.md" "Customer handoff guide is present"
require_file "docs/CUSTOMER_OPERATING_MODEL.md" "Customer operating model document is present"
require_file "docs/PILOT_ROLES_AND_RESPONSIBILITIES.md" "Pilot roles and responsibilities document is present"
require_file "docs/ACCESS_AND_APPROVAL_BOUNDARIES.md" "Access and approval boundaries document is present"
require_file "docs/EXCEPTION_HANDLING_RUNBOOK.md" "Exception handling runbook is present"
require_file "docs/CUSTOMER_INCIDENT_FLOW.md" "Customer incident flow document is present"
require_file "docs/PILOT_REPORTING_CADENCE.md" "Pilot reporting cadence document is present"
require_file "docs/WEEKLY_OPERATIONS_RHYTHM.md" "Weekly operations rhythm document is present"
require_file "docs/CONTROL_PLANE_RELEASE_READINESS.md" "Control-plane release readiness document is present"
require_file "docs/NEXT_ENGINEERING_PASS_RECOMMENDATION.md" "Next engineering pass recommendation is present"
require_file "docs/RELEASE_DEPLOY_RUNBOOK.md" "Release deploy runbook is present"
require_file "docs/DEPLOYMENT_VERIFICATION.md" "Deployment verification document is present"
require_file "docs/HOSTED_PILOT_VERIFICATION_CHECKLIST.md" "Hosted pilot verification checklist is present"
require_file "docs/INCIDENT_TRIAGE_RUNBOOK.md" "Incident triage runbook is present"
require_file "docs/HOSTED_PILOT_TOPOLOGY.md" "Hosted pilot topology document is present"
require_file "docs/SINGLE_TENANT_DEPLOYMENT_MODEL.md" "Single-tenant deployment model is present"
require_file "docs/INFRASTRUCTURE_ASSUMPTIONS.md" "Infrastructure assumptions document is present"
require_file "docs/DATABASE_AND_MIGRATIONS.md" "Database and migrations document is present"
require_file "docs/TLS_SETUP.md" "TLS setup document is present"
require_file "docs/OBJECT_STORAGE_CONFIGURATION.md" "Object storage configuration document is present"
require_file "docs/LOGGING_COLLECTION.md" "Logging collection document is present"
require_file "docs/BACKUP_RESTORE_ASSUMPTIONS.md" "Backup and restore assumptions document is present"
require_file "docs/PILOT_GO_LIVE_CHECKLIST.md" "Pilot go-live checklist is present"
require_file "docs/RELEASE_ARTIFACT_HYGIENE.md" "Release artifact hygiene document is present"
require_file "docs/PRODUCTION_TRUST_BOUNDARY_PLAN.md" "Production trust-boundary plan is present"
require_file "docs/SERVICE_IDENTITY_PLAN.md" "Service identity plan is present"
require_file "docs/MANAGED_SIGNING_PLAN.md" "Managed signing plan is present"
require_file "docs/REAL_CAPABILITY_RELEASE_PLAN.md" "Real capability release plan is present"
require_file "docs/OBSERVABILITY_AND_DEPLOYMENT_PLAN.md" "Observability and deployment plan is present"
require_file "docs/DEPLOYMENT_TOPOLOGY.md" "Deployment topology document is present"
require_file "docs/OPERATIONS_RUNBOOK.md" "Operations runbook is present"
require_file "docs/PILOT_ENVIRONMENT_REQUIREMENTS.md" "Pilot environment requirements document is present"
require_file "docs/PILOT_SCOPE_AND_BOUNDARIES.md" "Pilot scope and boundaries document is present"
require_file "docs/PILOT_ARCHITECTURE.md" "Pilot architecture document is present"
require_file "docs/PILOT_INTEGRATION_CHECKLIST.md" "Pilot integration checklist is present"
require_file "docs/PILOT_OPERATOR_JOURNEY.md" "Pilot operator journey is present"
require_file "docs/PILOT_SUCCESS_METRICS.md" "Pilot success metrics document is present"
require_file "docs/PILOT_DELIVERY_PLAN.md" "Pilot delivery plan is present"
require_file "docs/PILOT_LIMITATIONS.md" "Pilot limitations document is present"
require_file "docs/PILOT_SECURITY_AND_TRUST_BOUNDARY_SUMMARY.md" "Pilot security and trust-boundary summary is present"
require_file "docs/DEPLOYABILITY_AUDIT.md" "Deployability audit is present"
require_file "docs/CONTAINERIZATION_PLAN.md" "Containerization plan is present"
require_file "docs/RUNTIME_DEPENDENCIES.md" "Runtime dependencies document is present"
...
require_text "docs/SYSTEM_EXPLANATION_PLAIN_ENGLISH.md" 'open execution kernel|approvals|receipts' "Plain-English explanation covers kernel boundary and workflow"
require_text "docs/SYSTEM_EXPLANATION_ENGINEERING.md" 'Ownership Boundary|ReceiptRecord|ServicePrincipal' "Engineering explanation covers boundaries and implemented subsystems"
require_text "docs/LIVE_PILOT_OVERVIEW.md" 'What The Customer Sees|What Runs Behind It|End-To-End Pilot Flow|separate verifier repo or verifier interface' "Live pilot overview explains the managed pilot end to end"
require_text "docs/DEPLOYMENT_AND_OPERATIONS_INDEX.md" 'System Shape|Concrete Deployment Artifacts|Live Operations|What Is Still Outside This Repo' "Deployment and operations index maps the hosted pilot docs coherently"
require_text "docs/CUSTOMER_HANDOFF_GUIDE.md" 'What This Pilot Is|What The Provider Runs For The Customer|What This Pilot Does Not Claim' "Customer handoff guide stays practical and honest"
require_text "docs/CUSTOMER_OPERATING_MODEL.md" 'Customer-Operated Workflow|Provider-Operated Service Layer|token issuance' "Customer operating model separates customer workflow from provider-managed functions"
require_text "docs/PILOT_ROLES_AND_RESPONSIBILITIES.md" 'Finance Reviewer|Approver|Policy Administrator|Provider Platform Administrator' "Pilot roles document covers customer and provider roles"
require_text "docs/ACCESS_AND_APPROVAL_BOUNDARIES.md" 'Seeing An Action Is Not The Same As Acting On It|Block|Proof Verification Is External' "Access boundaries document separates visibility, approval authority, blocked outcomes, and verifier boundary"
require_text "docs/EXCEPTION_HANDLING_RUNBOOK.md" 'Held For Approval|Blocked By Policy|Proof Issuance Failed Or Rejected|Manual Escalation Path' "Exception handling runbook covers the main pilot exception classes"
require_text "docs/CUSTOMER_INCIDENT_FLOW.md" 'First Response Model|Customer Starts|Provider Starts|Closure Criteria' "Customer incident flow defines live incident ownership and closure"
require_text "docs/PILOT_REPORTING_CADENCE.md" 'Weekly Operating Summary|Weekly Success-Metrics Review|Pilot Review Cadence' "Pilot reporting cadence aligns to regular customer trust reviews"
require_text "docs/WEEKLY_OPERATIONS_RHYTHM.md" 'Daily Rhythm|Early-Week Exception Sweep|Midweek Change Review|End-Week Operating Review' "Weekly operations rhythm defines the recurring live pilot cadence"
require_text "docs/CONTROL_PLANE_RELEASE_READINESS.md" 'Internal development readiness|Design-partner pilot readiness|Production deployment readiness' "Release readiness doc covers the three required readiness levels"
require_text "docs/CONTROL_PLANE_RELEASE_READINESS.md" 'Green|Amber|Red' "Release readiness doc uses green amber red ratings"
require_text "docs/NEXT_ENGINEERING_PASS_RECOMMENDATION.md" 'Production trust-boundary hardening|managed KMS|service-to-service identity' "Next-pass recommendation focuses on the highest-value production hardening work"
require_text "docs/RELEASE_DEPLOY_RUNBOOK.md" 'Pre-Deploy Checks|Deployment Sequence|Rollback' "Release deploy runbook defines the pilot deployment flow"
require_text "docs/DEPLOYMENT_VERIFICATION.md" 'Runtime Verification|Startup Log Verification|Functional Pilot Verification' "Deployment verification doc defines the post-deploy checks"
require_text "docs/HOSTED_PILOT_VERIFICATION_CHECKLIST.md" 'X-Request-ID|runtime.startup.complete|/pilot/actions|/pilot/review' "Hosted pilot verification checklist covers correlation, startup, and pilot UI checks"
require_text "docs/INCIDENT_TRIAGE_RUNBOOK.md" 'Endpoint Or Ingress Failure|Process Live But Not Ready|External Dependency Boundary' "Incident triage runbook defines the minimum hosted pilot diagnosis flow"
require_text "docs/HOSTED_PILOT_TOPOLOGY.md" 'Managed PostgreSQL|Mounted Persistent Evidence Volume|Managed Object Storage Bucket|Central Log Collection' "Hosted pilot topology defines the minimum hosted shape"
require_text "docs/SINGLE_TENANT_DEPLOYMENT_MODEL.md" 'one dedicated runtime deployment|one real customer organization per deployment|not be run like a general shared SaaS environment' "Single-tenant deployment model keeps the pilot operationally isolated"
require_text "docs/INFRASTRUCTURE_ASSUMPTIONS.md" 'mounted writable filesystem path|object storage|TLS termination|structured JSON' "Infrastructure assumptions define storage, ingress, and logging boundaries"
require_text "docs/DATABASE_AND_MIGRATIONS.md" 'managed PostgreSQL|alembic upgrade head' "Database and migration guidance matches the runtime path"
require_text "docs/TLS_SETUP.md" 'TLS termination|reverse proxy|pilot hostname' "TLS setup guidance matches the hosted pilot model"
require_text "docs/OBJECT_STORAGE_CONFIGURATION.md" 'not yet the native write path|mounted filesystem path' "Object storage document preserves current storage truth"
require_text "docs/LOGGING_COLLECTION.md" 'standard output|central log destination' "Logging document describes central collection from container logs"
require_text "docs/BACKUP_RESTORE_ASSUMPTIONS.md" 'filesystem-backed evidence storage|manual operator procedure' "Backup assumptions document stays honest about current restore posture"
require_text "docs/PILOT_GO_LIVE_CHECKLIST.md" 'health/live|health/ready|capability release is still simulated' "Go-live checklist covers verification and pilot truth"
...
require_text "docs/RELEASE_ARTIFACT_HYGIENE.md" 'MANIFEST\.in|package build smoke|generated artifacts' "Release artifact hygiene doc defines package-surface hygiene"
require_text "docs/PRODUCTION_TRUST_BOUNDARY_PLAN.md" 'What Exists Today|What Is Simulated Today|What Must Change For Production' "Trust-boundary plan documents current and future state"
require_text "docs/SERVICE_IDENTITY_PLAN.md" 'design-partner pilot|workload identity|service principal' "Service identity plan covers pilot and production identity needs"
require_text "docs/MANAGED_SIGNING_PLAN.md" 'development-local HMAC|managed KMS|HSM' "Managed signing plan distinguishes current and target signing posture"
require_text "docs/REAL_CAPABILITY_RELEASE_PLAN.md" 'development_simulated|external managed|protected resource' "Capability release plan distinguishes simulated and real release paths"
require_text "docs/OBSERVABILITY_AND_DEPLOYMENT_PLAN.md" 'structured logs|metrics|tracing|alerting' "Observability and deployment plan covers current and target operations posture"
require_text "docs/DEPLOYMENT_TOPOLOGY.md" 'open kernel|managed database|object store|ingress' "Deployment topology covers the pilot environment shape"
require_text "docs/OPERATIONS_RUNBOOK.md" 'Health Checks|Incident Triage|Rollback' "Operations runbook covers core operator actions"
require_text "docs/PILOT_ENVIRONMENT_REQUIREMENTS.md" 'managed PostgreSQL|TLS|log shipping|non-default secrets' "Pilot environment requirements define the pilot baseline"
require_text "docs/PILOT_SCOPE_AND_BOUNDARIES.md" 'action_type = "payment"|refunds|out of scope' "Pilot scope defines the exact in-scope action and out-of-scope actions"
require_text "docs/PILOT_ARCHITECTURE.md" 'Separate Open Kernel|Actenon Cloud|simulated' "Pilot architecture distinguishes kernel, control plane, and simulated components"
require_text "docs/PILOT_INTEGRATION_CHECKLIST.md" 'operator|service principal|receipt|policy' "Pilot integration checklist defines customer inputs"
require_text "docs/PILOT_OPERATOR_JOURNEY.md" 'approve|evidence|proof|receipt' "Pilot operator journey covers the governed payment flow"
require_text "docs/PILOT_SUCCESS_METRICS.md" 'blocked|duplicate|receipt|confidence' "Pilot success metrics cover safety and operator value"
require_text "docs/PILOT_DELIVERY_PLAN.md" 'Phase 0|Phase 1|Phase 4|production-hardening' "Pilot delivery plan defines phases and exit path"
require_text "docs/PILOT_LIMITATIONS.md" 'does not claim|simulated|production-ready' "Pilot limitations document stays honest about maturity"
require_text "docs/PILOT_SECURITY_AND_TRUST_BOUNDARY_SUMMARY.md" 'trust boundary|simulated|managed PostgreSQL|not a fully hardened production trust boundary' "Pilot security summary explains current trust limits honestly"
require_text "docs/DEPLOYABILITY_AUDIT.md" 'FastAPI|PostgreSQL|filesystem|verifier' "Deployability audit defines the current pilot runtime honestly"
require_text "docs/CONTAINERIZATION_PLAN.md" 'Dockerfile|docker-compose\.yml|migrate|web' "Containerization plan defines the image and commands"
require_text "docs/RUNTIME_DEPENDENCIES.md" 'PostgreSQL|filesystem|verifier' "Runtime dependencies document defines required runtime dependencies"
...
require_text "docs/REPO_BOOTSTRAP_PLAN.md" '## Phase 0' "Bootstrap plan defines phase 0"
